...
setup(
    ...
    package_dir={'': 'cltl'},
    packages=find_namespace_packages(include=['brain.*']),
    package_data={'brain': ['ontologies/*', 'queries/*']},
    python_requires='>=3.7',
    install_requires=[#'cltl.combot @ git+https://github.com/leolani/cltl-combot.git#e76f2baa4668d9546e93c7e5a5df102648d40c17',
                      'requests==2.25.0',
                      'rdflib==5.0.0',
                      'sparqlwrapper==1.8.5',
                      'numpy==1.20.0',
